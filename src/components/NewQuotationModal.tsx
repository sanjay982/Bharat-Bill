    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      ...
      >
        <div className="p-4 md:p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
          <div>
            <h3 className="text-lg md:text-xl font-bold text-slate-900">Create New Quotation</h3>
            <p className="text-[10px] md:text-xs text-slate-500 font-medium">Generate a professional quotation</p>
          </div>
