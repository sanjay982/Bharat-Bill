...
export const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || import.meta.env.NEXT_PUBLIC_SUPABASE_URL || 'https://acayunbbncdwzppkqogg.supabase.co';
...
console.log('Supabase initialized with Anon Key:', supabaseAnonKey ? 'Present' : 'Missing');
